...
export const directionDetailsStyles = StyleSheet.create({
  ...
  hybridSectionCard: {
    ...
    paddingHorizontal: 8,
    borderRadius: 22,
    backgroundColor: 'rgba(96, 25, 39, 0.82)',
    borderWidth: 1,
    borderColor: 'rgba(255, 255, 255, 0.12)',
    boxShadow: '0 8px 14px rgba(42, 7, 15, 0.34)',
  },
  hybridSectionTitle: {
    color: '#FFFFFF',
    fontSize: 14,
  ...
  hybridModeRow: {
    ...
    gap: 0,
    borderRadius: 24,
    backgroundColor: 'rgba(63, 11, 21, 0.92)',
    borderColor: 'rgba(36, 4, 10, 0.92)',
    boxShadow: 'inset 0 -2px 4px rgba(0, 0, 0, 0.26)',
  },
  hybridModeButton: {
    flex: 1,
    minHeight: 42,
  ...
  hybridModeButtonActive: {
    backgroundColor: 'rgba(124, 29, 45, 0.96)',
    boxShadow: '0 4px 8px rgba(28, 4, 10, 0.2)',
  },
  hybridSummaryCard: {
    marginTop: 10,
    marginBottom: 10,
  ...
  stageActionButton: {
    ...
    borderRadius: 999,
    backgroundColor: 'rgba(143, 34, 54, 0.96)',
    borderWidth: 1,
