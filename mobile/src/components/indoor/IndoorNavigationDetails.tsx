        ...
        >
            ...
            <View style={directionDetailsStyles.header}>
                <View style={directionDetailsStyles.transitHeaderTextWrap}>
                    <Text style={[directionDetailsStyles.directionTitle, directionDetailsStyles.transitHeaderTitleText]}>
            ...
            {/* FLOOR NAV */}
            {onPrevFloor && onNextFloor && (
                <View style={{ flexDirection: 'row', gap: 10, marginBottom: 10 }}>
                    <TouchableOpacity
                        style={{ flex: 1, backgroundColor: 'rgba(146,35,56,0.9)', borderRadius: 12, padding: 10, alignItems: 'center' }}
                        onPress={onPrevFloor}
                    >
